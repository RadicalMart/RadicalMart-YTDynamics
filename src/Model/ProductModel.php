...
use Joomla\Component\RadicalMart\Administrator\Model\ProductModel as BaseModel;
...
class ProductModel extends BaseModel
{
	...
	protected function loadForm($name, $source = null, $options = [], $clear = false, $xpath = null)
	{
		...
		$file_xml = file_get_contents(JPATH_ADMINISTRATOR . '/components/com_radicalmart/forms/product.xml');
